...
var HumRestApi = function() {
};

HumRestApi.prototype = new baseRestApi.BaseRestApi;

HumRestApi.prototype.getResponseCards = function(response, args) {
...
HumRestApi.prototype.getRequestCards = function(response, args) {
    console.log("Request handler 'responseCards' was called.");
    response.writeHead(200, {
        "Content-Type": "application/json"
    });
...
HumRestApi.prototype.getResponseSubmissions = function(response, args) {
...
HumRestApi.prototype.getRequestCard = function(response, args) {
    response.writeHead(200, {
        "Content-Type": "application/json"
    });
    console.log('helo');
...
HumRestApi.prototype.submitResponse = function(response, args) {
...
HumRestApi.prototype.selectResponse = function(response, args) {
